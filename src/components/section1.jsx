			...
			<div className='flex min-h-screen flex-col'>
				<main className='flex-grow'>
					<section className='relative bg-hero bg-cover bg-center'>
						<div className='container mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-48 flex flex-col items-center justify-center text-center text-white'>
							<h1 className='text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight max-w-4xl'>
								Арендуй автомобиль любого-класса в{' '}
								<span className='text-[#0c7ff2]'>Таджикистане</span>
							</h1>
							...
							<form className='mt-10 w-full max-w-3xl bg-background-light/20 dark:bg-background-dark/30 backdrop-blur-md p-4 rounded-lg shadow-2xl'>
								<div className='grid grid-cols-1 md:grid-cols-4 gap-4 items-end'>
									<div className='col-span-1 md:col-span-3 grid grid-cols-1 sm:grid-cols-3 gap-4'>
										...
										<div>
											<label className='sr-only' for='car'>
												Марка/модель
											</label>
											<div className='relative'>
												<div className='pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3'>
										...
										<div>
											<label className='sr-only' for='dates'>
												Даты аренды
											</label>
											<div className='relative'>
												<div className='pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3'>
									...
									>
										...
										<span className=''>Найти машину</span>
									</button>
								</div>
							</form>
						</div>
